...
var BillingNameInfo = React.createClass({
  ...
  componentDidMount:function(){
    const  _this = this;
    this.fetch(rootURL + '/business/BaiduXML/guess-next-child/' + this.props.localState.parentId,function(result){
        ...
        genTr.push(
          ...
          <td>
            <Select showSearch 
                    ...
                    notFoundContent="无法找到" style={{ width: 130 }}  {...getFieldProps('line_name_' + i,{ initialValue:stateconnectdata[i].line })}>
...
var BillingNameChildUpdate = React.createClass({
  ...
  store:function(e){
    ...
    var url = _this.props.location.state.type === 'add'? '/business/BaiduXML/store' : '/business/BaiduXML/update/' + _this.props.location.query.id ;
